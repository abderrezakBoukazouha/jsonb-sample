...
class BookControllerTest {
    ...
    void givenNoneEmptyDataBase_whenSearchingViaIsbn_shouldReturnListOfBooks(String isbn) throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/book?isbn=%s".formatted(isbn))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].bookId").isString())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].publicationDate").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors").isArray())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[0]").isMap())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[0].authorId").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[0].firstName").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[0].lastName").isString())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[0].birthYear").isNumber())
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[0].nationality").isString())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].authors[1].authorId").isString())
